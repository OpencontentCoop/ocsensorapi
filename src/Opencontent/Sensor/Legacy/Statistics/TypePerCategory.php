...
class TypePerCategory extends StatisticFactory
{
    ...
    {
        return Translator::translate('Type by category', 'chart');
    }

    public function getDescription()
    {
        return Translator::translate('Type of issues by category', 'chart');
    }
    ...
    public function getData()
    {
        if ($this->data === null) {
            ...
            $search = $this->repository->getStatisticsService()->searchPosts(
                "{$categoryFilter}{$areaFilter}{$rangeFilter}{$groupFilter}{$userGroupFilter} limit 1 facets [raw[submeta_category___id____si]|alpha|1000] pivot [facet=>[attr_type_s,submeta_category___id____si],mincount=>{$this->minCount}]",
